...
document.addEventListener('DOMContentLoaded', function() {
  ...
  window.addEventListener('message', function(event) {
      ...
      } else if (event.data.type === 'loadbounty') {
          navigateTo(`bounty.html?id=${event.data.bountyId}`);
      } else if (event.data.type === 'bountyCompleted') {
          alert(`bounty ${event.data.bountyId} completed!`);
          navigateTo('availablebounties.html');
      }
  });
